...
class SegmentationTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        self.augmentation_dict = {
            "flip": self.cli_args.augmented or self.cli_args.augment_flip,
            "offset": 0.03 if self.cli_args.augmented or self.cli_args.augment_offset else 0.0,
            "scale": 0.2 if self.cli_args.augmented or self.cli_args.augment_scale else 0.0,
            "rotate": True if self.cli_args.augmented or self.cli_args.augment_rotate else False,
            "noise": 25.0 if self.cli_args.augmented or self.cli_args.augment_noise else 0.0,
        }
